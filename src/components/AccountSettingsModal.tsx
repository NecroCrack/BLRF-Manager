    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6" style={{ background: "rgba(4,7,13,0.85)" }}>
      <div className="w-full max-w-md clip-corner p-6 max-h-[85vh] overflow-y-auto scrollable" style={{ background: "#070d1a", border: "1px solid #12223a" }}>
        ...
        <form onSubmit={handleSave}>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              style={{ color: "#8aabca", border: "1px solid #12223a" }}
            />
            <div className="font-jbmono text-[11px] mt-1.5 leading-relaxed" style={{ color: "#3d5878" }}>
        ...
        <div className="pt-4" style={{ borderTop: "1px solid #12223a" }}>
          <div className="font-jbmono text-[11px] mb-3" style={{ color: "#3d5878" }}>
            Plugin EDMC (localisation &amp; colonisation)
          </div>

          {pluginStatus?.configured && !newToken && (
            <div className="font-jbmono text-[12px] mb-3 px-3 py-2 clip-corner-sm" style={{ color: "#0fc882", background: "rgba(15,200,130,0.08)", border: "1px solid rgba(15,200,130,0.25)" }}>
              Jeton configuré.{" "}
          ...
          {newToken ? (
            <div className="mb-3">
              <div className="font-jbmono text-[11px] mb-2 px-3 py-2 clip-corner-sm" style={{ color: "#e53030", background: "rgba(229,48,48,0.1)", border: "1px solid rgba(229,48,48,0.25)" }}>
                Ce jeton ne sera plus jamais affiché. Copiez-le dans la configuration du plugin maintenant.
              </div>
              <div
                className="font-jbmono text-[12px] mb-2 px-3 py-2 clip-corner-sm break-all"
            ...
            <button
              ...
              className="w-full font-orbitron text-[11px] py-2 clip-corner-sm transition-all disabled:opacity-50"
          ...
          <div className="font-jbmono text-[11px] mt-2 leading-relaxed" style={{ color: "#3d5878" }}>
