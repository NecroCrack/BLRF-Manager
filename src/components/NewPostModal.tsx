    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6" style={{ background: "rgba(4,7,13,0.85)" }}>
      <div className="w-full max-w-lg clip-corner p-6" style={{ background: "#070d1a", border: "1px solid #12223a" }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label className="font-orbitron text-[9px] tracking-widest block mb-1.5" style={{ color: "#3d5878" }}>TITRE</label>
            <input
          ...
          <div className="mb-3">
            <label className="font-orbitron text-[9px] tracking-widest block mb-1.5" style={{ color: "#3d5878" }}>CATÉGORIE</label>
            <select
          ...
          <div className="mb-5">
            <label className="font-orbitron text-[9px] tracking-widest block mb-1.5" style={{ color: "#3d5878" }}>CONTENU</label>
            <textarea
